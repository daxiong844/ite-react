  ...
  return (
    ...
    >
      <div className="earningTop" style={{ height: '0.2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.05rem' }}>
        ...
        <Button className="creatorsButton" type="link" style={{ color: 'rgba(207,203,230,0.62)', fontSize: '0.07rem', marginRight: '0.1rem' }}>
          {t('Dashboard.See all')}
        </Button>
      </div>
      <div style={{ width: '1.34rem', height: '0.25rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.1rem' }}>
        ...
        <Button className="creatorsButton" style={{ width: '0.4rem', color: 'rgba(205, 198, 249, 1)', fontSize: '0.06rem', backgroundColor: 'rgba(130, 112, 235, 0.20)', border: 'none' }}>
          {t('Dashboard.Follow')}
        </Button>
      </div>
      <div style={{ width: '1.34rem', height: '0.25rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.1rem' }}>
