  ...
  return (
    <Row>
      ...
      <Col span={20} style={{ backgroundColor: '#0B0A24' }}>
        <Input placeholder="Search..." style={{ width: '2.915rem', background: '#201E43', outline: 'none', border: 0, color: '#727191', marginRight: '0.795rem', marginLeft: '0.16rem', height: '0.24rem', marginTop: '0.245rem' }}></Input>
        <Language></Language>
      </Col>
    </Row>
  )
